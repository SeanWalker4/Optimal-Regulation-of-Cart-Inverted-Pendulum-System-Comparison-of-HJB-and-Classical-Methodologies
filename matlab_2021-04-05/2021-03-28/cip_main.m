...
t_f = 50;                         % Final time (s).
numtpts = 1000;                   % Number of time instants in time vector.
tvec = linspace(t_i,t_f,numtpts); % Time vector.
...
% *************************************************************************
% 
% GENERALIZED MIXED SENSITIVITY (GMS)
%
% *************************************************************************
% *************************************************************************
...
lgd_text = {'|S_c|', '\gamma_{opt} |W_4^{-1}|'};
wvec_cell = wvec;

plottypes = [1;0];  
ttl_cell = {['Sensitivity at Control S_c']};
axes_cell = {axes_vec_mag};
...
lgd_text = {'|T_c|', '\gamma_{opt} |W_6^{-1}|'};
wvec_cell = wvec;

plottypes = [1;0];  
ttl_cell = {['Complementary Sensitivity at Control T_c']};
axes_cell = {axes_vec_mag};
...
plottypes = [1;0];  
ttl_cell = {['Sensitvity S_c and Complementary Sensitivity T_c at Control']};
axes_cell = {axes_vec_mag};
